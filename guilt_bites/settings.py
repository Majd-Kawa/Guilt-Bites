"""
Django settings for guilt_bites project.
...
SECRET_KEY = 'django-insecure-10e6gtbux5zi!ldrmpfo5s@!n@hiyx#^7e81e8cv2dkj%bn=qv'
...
WSGI_APPLICATION = 'guilt_bites.wsgi.application'
